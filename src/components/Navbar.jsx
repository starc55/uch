    ...
    <>
      ...
      <motion.header
        ...
        animate={{
          ...
          backgroundColor:
            scrolled || menuOpen ? 'rgba(10, 10, 10, 0.72)' : 'rgba(10, 10, 10, 0)',
        }}
        ...
        <div className="mx-auto max-w-7xl">
          ...
          >
            <div className="flex items-center justify-between gap-4">
              ...
              >
                <img src={logo} alt="UCH" className="h-12 w-12 object-contain sm:h-14 sm:w-14" />
                  ...
                  >
                    <div className="mb-4 flex items-center justify-between rounded-2xl border border-white/8 bg-black/20 px-4 py-3">
                      <div>
                        ...
                        <p className="mt-1 text-sm text-white/58">Explore the UCH system</p>
                      </div>
                    ...
                    >
                      <span className="text-sm font-medium text-accent">Start a build</span>
